        ...
        <div className="lg:col-span-4 space-y-4">
          <div className="bg-[#0A0A0A] text-white p-5 border border-[#0A0A0A] space-y-3">
            ...
            <p className="text-xs text-neutral-300 font-sans leading-relaxed">
              {customer.segment === 'VIP'
                ? 'High-priority collector with priority drop allocation and direct stylist liaison privileges.'
                : 'Active customer with repeat purchase affinity for oversized tees and fleece silhouettes.'}
            </p>
            <div className="pt-2 border-t border-neutral-800 space-y-1.5 font-mono text-[11px]">
              <div className="flex justify-between text-neutral-400">
                <span>FAVORITE SILHOUETTE:</span>
                <span className="text-white font-bold">OVERSIZED TEES (L)</span>
              </div>
              <div className="flex justify-between text-neutral-400">
                <span>PREFERRED PAYMENT:</span>
                <span className="text-white font-bold">UPI / INSTANT</span>
              </div>
              <div className="flex justify-between text-neutral-400">
          ...
          <div className="bg-white border border-[#CFCFD2] p-5 space-y-3 font-mono text-xs">
            <h4 className="font-bold text-[11px] uppercase tracking-widest text-[#888888]">
              INTERNAL NOTES & SIZING LOG
            </h4>
            <div className="p-3 bg-[#F1F1F3] border border-[#CFCFD2] text-[#444444] text-xs">
              Customer confirmed size Large offers the ideal boxy streetwear drape. Prefers dark monochrome colorways (Obsidian / Washed Black).
            </div>
          </div>
        </div>
      </div>
