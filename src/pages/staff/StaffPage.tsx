  ...
  return (
    <div className="space-y-6 animate-in fade-in duration-200">
      ...
      <div className="bg-white border border-[#CFCFD2] overflow-hidden">
        <div className="p-4 border-b border-[#CFCFD2] bg-[#FAFAFA] flex items-center justify-between">
          <h3 className="font-mono text-xs font-bold uppercase tracking-wider text-[#0A0A0A]">
            AUTHORIZED OPERATOR DIRECTORY
          </h3>
          <span className="text-xs font-mono text-[#888888]">{staff.length} Active Accounts</span>
        </div>
                  ...
                  <td className="py-3 px-4">
                    <div className="flex flex-wrap gap-1">
                      {member.permissions.map((perm) => (
                        <span
                          key={perm}
                          className="text-[9px] font-mono px-1.5 py-0.2 bg-[#F1F1F3] text-[#444444] border border-[#CFCFD2]"
                        >
                          {perm}
                        </span>
                      ))}
